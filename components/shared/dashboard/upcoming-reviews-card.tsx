...
import { Clock, Calendar, FileCheck, ShieldCheck, FileText } from "lucide-react"
          ...
          <div className="flex items-center justify-between">
            ...
            {hasNext30 && (
              <Badge variant="secondary" className="bg-amber-100 text-amber-800">
                {next30Days.criticalityCount + next30Days.riskCount + next30Days.auditCount} total
              </Badge>
            )}
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            {has30to90 && (
              <Badge variant="outline">
                {next30to90.criticalityCount + next30to90.riskCount + next30to90.auditCount} total
              </Badge>
            )}
          </div>
